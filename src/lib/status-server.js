...
function normalizeGameList(input) {
  ...
  const valid = new Set(['ALS', 'AG', 'AC', 'UTD', 'AV', 'BL', 'SP', 'ARX', 'APX']);
...
const GAME_QUESTIONNAIRES = {
  ...
  BL: [
    'What is your Roblox Username?',
    'How active can you be to help people out in game?',
    'What is your current Race and Mastery level?',
    'Do you have experience with high-tier PvP carries?',
    'Please send an screenshot of your character/build below'
  ],
  SP: [
    'What is your Roblox Username?',
    'How active can you be to help people out in game?',
